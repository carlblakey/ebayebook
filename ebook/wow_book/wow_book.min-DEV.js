...
window.Modernizr = function(e, p, w) {
        ...
        var d = a.call(arguments, 1),
            e = function() {
                if (this instanceof e) {
                    ...
                    g = new g;
                    var f = c.apply(g, d.concat(a.call(arguments)));
    ...
    for (var f in n) g(n, f) && (b = f.toLowerCase(), m[b] = n[f](), F.push((m[b] ? "" : "no-") + b));
    B.cssText = "";
    return n = null, m._version = "2.5.3", m._prefixes = e, m._domPrefixes = D, m._cssomPrefixes = C, m.testProp = function(a) {
        return u([a])
    }, m.testAllProps = r, m.testStyles = c, m.prefixed = function(a, b, c) {
...
(function(e, p, w) {
    ...
    var B = function() {
        ...
        e.browser.msie && !n && function() {
            var a, f;
            z.start = function() {
                a || (f = (f = e.fn.hashchange.src) && f + u(), a = e('<iframe tabindex="-1" title="empty"/>').hide().one("load", function() {
                    f || c(u());
                    m()
                }).attr("src", f || "javascript:0").insertAfter("body")[0].contentWindow, r.onpropertychange = function() {
                    try {
                        "title" ===
                        event.propertyName && (a.document.title = r.title)
                    } catch (h) {}
                })
            };
            z.stop = b;
            ...
            c = function(b, c) {
                ...
                b !== c && (d.title = r.title, d.open(), g && d.write('<script>document.domain="' + g + '"\x3c/script>'), d.close(), a.location.hash = b)
            }
        }();
        return z
    }()
...
try {
    (function(e, p, w, u) {
        ...
        function q(a, b, d) {
            ...
            8 != d.eventType && (25 < e || A.velocity === u) ? (f = d.deltaX - A.deltaX, A = d.deltaY - A.deltaY, h = f / e || 0, k = A / e || 0, e = h, g =
        ...
        e.MSPointerEvent && (ja = "MSPointerDown", ka = "MSPointerMove MSPointerUp MSPointerCancel");
        C(S, v, {
            handler: function(a) {
                var b = this.store,
                    c = !1,
        ...
        var pa =
            k(Aa.style, "touchAction"),
            qa = pa !== u;
        W.prototype = {
            set: function(a) {
                "compute" == a && (a = this.compute());
                qa && this.manager.element.style && (this.manager.element.style[pa] = a);
        ...
        C(Y, G, {
            ...
            process: function(a) {
                ...
                else if (a.eventType & 1) this.reset(), this._timer = r(function() {
                    this.state = 8;
                    this.tryEmit()
                }, b.time, this);
            ...
            process: function(a) {
                ...
                if (d && e && c) {
                    ...
                    this.count = d && c ?
                        this.count + 1 : 1;
                    this._input = a;
                    if (0 === this.count % b.taps) return this.hasRequireFailures() ? (this._timer = r(function() {
                        this.state = 8;
                        this.tryEmit()
                    }, b.interval, this), 2) : 8
                }
        ...
        "function" == typeof define && define.amd ? define(function() {
            ...
            "undefined" != typeof module && module.exports ? module.exports = H : e[w] = H
...
(function(e) {
    function p(a, b) {
        ...
        if (b.deepLinking && this.getLocationHash()) {
            ...
            "number" === typeof l && (c.startPage = l, b.moveToViewPort && !u(c.elem) && c.elem[0].scrollIntoView())
        }
        this.flipSound && (this.audio = this.createAudioPlayer());
        this.opts.keyboardNavigation && (l = e.wowBook.defaults.keyboardNavigation, this.rtl && this.opts.keyboardNavigation == l && (this.opts.keyboardNavigation = {
            back: l.advance,
            advance: l.back
        }), e(document).on("keydown.wowbook", function(a) {
            e(a.target).filter("input, textarea, select").length ||
                c.holdedPage || c.opts.lightbox && !c.lightboxOn || (a.which === c.opts.keyboardNavigation.back && c.back(), a.which === c.opts.keyboardNavigation.advance && c.advance())
        }));
        e(window).on("hashchange.wowbook", function() {
            ...
            if (a === c.locationHashSetTo) c.locationHashSetTo = void 0;
                ...
                "number" === typeof d && (c.gotoPage(d, !a), a || !b.moveToViewPort || u(c.elem) || c.elem[0].scrollIntoView())
            }
        });
    ...
    function r(a, b, c) {
        ...
        if (!e.wowBook.support.boxSizing) {
            ...
            d = "none" == a.css("borderRightStyle") ?
                0 : z[f = a.css("borderRightWidth")] || parseFloat(f);
    ...
    p.prototype = {
        ...
        setPagesDimension: function() {
            for (var a, b, c, d = 0, g = this.pages.length; d <
                g; d++) page = this.pages[d], b = page.isCover ? this.pageWidth : this.opts.pageWidth || this.pageWidth, c = page.isCover ? this.pageHeight : this.opts.pageHeight || this.pageHeight, page.pageWidth = b, page.pageHeight = c, page.css({
                width: b,
                height: c,
                left: page.onLeft ? 0 : this.pageWidth
            }), a = e(".wowbook-page-content", page), r(a, b, c), this.setPageCorners(page);
        ...
        insertDoublePage: function(a, b) {
            if (!this._insertingDoublePage) {
                ...
                if (this.rtl) f = this.insertPage(d.parent(), !0), g = this.insertPage(c.parent(), !0);
                else {
                ...
                g && (g.otherHalf = f);
                f && (f.otherHalf = g);
                e.wowBook.support.boxSizing || (r(c, 2 * this.pageWidth, this.pageHeight), r(d, 2 * this.pageWidth, this.pageHeight));
                b || this.updateBook();
        ...
        selectPagesToUnload: function(a) {
            ...
            for (var k = 0, l = this.pages.length; k < l; k++) {
                var v = this.pages[k];
                v.loaded && k != c && k != a && k != d &&
                    k != e && k != f && k != h && !this.isPageToKeep(v) && b.push(k)
            }
            return b
        },
        ...
        removePages: function(a, b) {
            ...
            c.push.apply(c, e);
            e = 0;
            for (var f = d.length; e < f; e++) d[e].remove();
            this.updateBook();
            return c.length
        },
        ...
        doPageNumbering: function() {
            ...
            if (a.pageNumbers && this.pages.length) {
                ...
                var g = this.opts.firstPageNumber;
        ...
        showPage: function(a, b) {
            ...
            for (var l =
                ...
                var t = l === g || l === c || l === d || l === f ? "block" : "none";
                this.pages[l].data("zIndex", v).css({
                    display: t,
            ...
            (c = this.onShowPage) && e.isFunction(c) && !this.isOnPage(a) && (this.currentPage = a, c(this, this.pages[a], a), (d = this.otherPage(a)) && c(this, this.pages[d], d));
            this.currentPage =
                a;
        ...
        holdPage: function(a, b, c, d, e) {
            ...
            if (a) {
                ...
                if (e) {
                    ...
                    if (!this._singlePage && this.centeredWhenClosed && (0 === f || 0 === l || k && (l === g || f === g))) {
                        var v = 0,
                            t = !this.rtl,
                            q = this.pageWidth;
                        if (t ? 0 === f : f === g && k) {
                        ...
                        if (t ? f === g && k : 0 === f) m = q, r = 3 * q / 2, n = q / 2, z = 0, p = q, u = 2 * q, B = b, w = u;
                        if (t ? 0 === l : l === g && k) m = q / 2, r = f === (t ? g : 0) ? q : 3 * q / 2, n = f === (t ? g : 0) ? q / 2 : 0, z = -q / 2, p = m, u = 2 * q, B = b, w = u;
                        if (t ? l === g && k : 0 === l) m = f === (t ? 0 : g) ? 0 : -q / 2, r = q / 2, n = q / 2, z = f === (t ? 0 : g) ? -q / 2 : 0, p = -q, u = r, B = p, w = b;
                        if (b < m) {
                            v = n;
                            var C = B
                        }
                        b > r && (v = z, C = w);
                        b >= m && b <= r && (b = (b - m) / (r - m), v = n + b * (z - n), C = p + b * (u - p));
                        b = C;
                        this.origin.css("left", v);
                        this.positionBookShadow()
                    }
                    this.zoomed || "basic" == this.pageType(a) || "basic" == this.pageType(e) ? this.foldPageBasic(a, b, c, d, e) : a.isHardPage ||
                        e.isHardPage ? this.holdHardpage(a, b, c, d, e) : this.foldPage(a, b, c, d, e);
        ...
        foldPage: function(a, b, c, d, e) {
            this._currentFlip || (this._currentFlip = this.foldPageStart(a,
                b, c, d, e));
        ...
        foldPageStyles: function(a) {
            ...
            if ("l" == v || "r" == v) {
                ...
                v = (k >= t.y ? "t" : "b") + (this.pageIsOnTheLeft(a.pageIndex) ? "l" : "r");
                a.corner = v;
            ...
            p = w(r, k);
            n = p.x + h + d + .5;
            a.pageContent.css("transform", f(-n, 0) + " rotate(" +
                (-q).toFixed(7) + "deg)");
            a.page.css("transform", f((Math.cos(k) * n).toFixed(5), (Math.sin(k) * n).toFixed(5)) + " rotate(" + q.toFixed(7) + "deg)");
            p = this.calculateOpacity(h, b, this.shadowThreshold, 50);
            if (this.shadows && 0 < p) {
                var z = a.shadowTop;
                this.internalShadow.css({
                    transform: f(n + (a.page.onRight ? a.page.pageWidth : 0), z) + " rotate(" + q + "deg)",
                    transformOrigin: d - n + "px " + (g + (a.shadowHeight - c) / 2) + "px"
                });
                n -= a.foldShadowWidth;
                this.foldShadow.css({
                    transform: f(n + (a.page.onRight ? a.page.pageWidth : 0), z) + " rotate(" + q + "deg)",
                    transformOrigin: d -
                        n + "px " + (g + (a.shadowHeight - c) / 2) + "px"
                });
            ...
            l = -(l.x + d);
            c = -(c.y - g);
            a.backContent.css("transform", f(-n, 0) + " rotate(" + q + "deg)");
            a.back.css("transform", f((v + l + Math.cos(k) * n).toFixed(5), (t - c + Math.sin(k) * n).toFixed(5)) + " rotate(" + q + "deg)");
            p = this.calculateOpacity(2 * h, 2 * b, this.foldGradientThreshold,
                50);
            this.foldGradient && 0 < p ? (this.foldGradientContainer.css({
                opacity: p,
                display: "block",
                transform: f(b - v - a.foldGradientWidth / 2, t - a.foldGradientHeight / 2) + " rotate(" + -q + "deg)"
        ...
        holdHardpage: function(a, b, c, d, e) {
            this._currentFlip || (this._currentFlip =
                this.flipHardPageStart(a, b, c, d, e));
            this._currentFlip.page == a && (this._currentFlip.x = b, this._currentFlip.y = c, this._currentFlip.page.data("holdedAt", {
                x: b,
                y: c
        ...
        flipHardPageStart: function(a, b, c, d, g) {
            ...
            if (g && g.length) {
                ...
                a.css("zIndex", 1E5);
                g.css("zIndex", 1E5);
                this.opts.use3d && Modernizr.csstransforms3d && (a.css(Modernizr.prefixed("perspectiveOrigin"),
                    "0 50%"), g.css(Modernizr.prefixed("perspectiveOrigin"), "0 50%"));
                b = a.onLeft ? h : 0;
        ...
        flipHardPageStyles: function(a) {
            ...
            if (this.opts.use3d && Modernizr.csstransforms3d) {
                ...
                if (this.animating) {
                    ...
                    if (this.curledPage || q.curled) q.curled = !0, q.angle || (m = {
                        from: t,
                        to: 0
                    }, q.angle = m, t = a + q.dx, m.to = f ? -this._calculateAngleFromX(-t,
                        h) : this._calculateAngleFromX(t, h), Math.abs(a) == h && (m.from = 0), Math.abs(t) == h && (m.to = 0), m.delta = m.to - m.from), t = q.angle.from - q.angle.delta * (q.from.x - d) / q.dx
                }
                g.append(this.border3D);
                this.hardPageShadow && (g.append(this.hardPageShadow), this.hardPageShadow.css("opacity", 1 - l));
                g.css({
            ...
            !e.wowBook.support.transform && e.wowBook.support.filters &&
                (g.css("filter", "progid:DXImageTransform.Microsoft.Matrix(" + ("M11=" + l + ", M12=0, M21=" + Math.tan(m) * l + ", M22=1") + ", sizingMethod='auto expand')"), g.css({
        ...
        foldPageBasicStyles: function(a) {
            ...
            var h = (f = this.pageIsOnTheLeft(a.pageIndex)) ?
                x : d - x;
            0 > h && (h = 0);
            h > 2 * d && (h = 2 * d);
            var k = h / 2;
            if (f) {
                ...
                h = b.left + (h - d)
            } else l = "rect(-1000px " + (d - k) + "px " + e + "px -1000px)", e = "rect(-1000px " + k + "px " + e + "px -1000px)", h = c.left + (d - h + d);
            b.css("clip", l);
            c.css({
                clip: e,
                left: h,
            ...
            this.shadows && 0 < l ? (b = f ? b.left + k - a.foldShadowWidth : c.left + d - k + d, this.shadowContainer.css("opacity", l), this.foldShadow.css({
                left: b,
                display: "block"
            })) : this.foldShadow.css("display", "none");
            l = this.calculateOpacity(2 * k, 2 * d, this.foldGradientThreshold, 50);
            this.foldGradient && 0 < l ? (b = f ? d - k : k - a.foldGradientWidth, this.foldGradientContainer.css({
                opacity: l,
                left: b,
                display: "block"
        ...
        flip: function(a, b, c, d) {
            ...
            if (!g.animating) {
                ...
                !c.isHardPage && .4 < a.duration / this.turnPageDuration &&
                    this.playFlipSound();
                this.currentFlip = a
            }
        },
        rafCallback: function() {
            ...
            if (this.currentFlip && !this.currentFlip.finished) {
                ...
                a.dragging && (a.x = a.initialX + .2 * a.deltaX, a.y = a.initialY + .2 *
                    a.deltaY, a.initialX = a.x, a.initialY = a.y, a.deltaX = a.finalX - a.initialX, a.deltaY = a.finalY - a.initialY, 1 > a.deltaX && 1 > a.deltaY && 1 == b);
        ...
        releasePage: function(a, b, c, d) {
            ...
            if (b && f) this.flip({
                ...
                this.foldGradientContainer.hide(), this.hardPageDropShadow.hide(), this.resetPage(a), c && c.length && (this.resetPage(c), c.hide()), this.foldShadow.removeClass("wowbook-shadow-fold-flipped").css({
                    transform: "",
                    left: ""
        ...
        gotoPage: function(a, b) {
            ...
            if (!this.animating) {
                ...
                if (h) {
                    ...
                    if (this.closable && this.differentPageSizes && h.isCover != l.isCover && h.pageIndex !== a) {
                        if (0 == h.pageIndex || 0 == l.pageIndex) this.showPage(1, !1);
                        else {
                            var m = this.pages.length - 1;
                            this.otherPage(m) || h.pageIndex != m && l.pageIndex != m || this.showPage(this.backPage(m).pageIndex, !1)
                        }
                        ...
                        if (d)
                            ...
                            for (d = h.pageIndex + 1, c = this.pages.length; d < c; d++) this.pages[d].css("display",
                                "none");
                        ...
                        e ? (t = t || {
                            x: 0,
                            y: 0
                        }, e = 2 * f.pageWidth, c = "bl" != d ? 0 : h.pageHeight) : (t = t || {
                            x: h.pageWidth,
                            y: 0
                        }, e = -h.pageWidth, c = "br" != d ? 0 : h.pageHeight);
                        var n = "linear";
                        if (this.centeredWhenClosed && !this._singlePage && (h.isHardPage || l.isHardPage)) {
                            m = this.pages.length - 1;
                            var r = !this.rtl;
                            n = "easeOutCubic";
                            this.pageIsOnTheRight(this.currentPage) && !this.otherPage(this.currentPage) && (e += this.pageWidth / 2, a != (r ? m : 0) || this.otherPage(a) || (e += this.pageWidth / 2));
                            this.pageIsOnTheLeft(this.currentPage) && !this.otherPage(this.currentPage) && (e -= this.pageWidth / 2, a != (r ? 0 : m) || this.otherPage(a) || (e -= this.pageWidth / 2))
                        }
                        if (this._singlePage) {
        ...
        gotoRight: function(a) {
            return this.gotoDirection("right",
                a)
        },
        ...
        leftPageIndex: function(a) {
            if (null != a) {
                this.pageIsOnTheRight(a) && (a += this.rtl ? 1 :
                    -1);
        ...
        fillToc: function(a, b) {
            ...
            if (0 !== c.length) {
                ...
                for (var f = 0, h = g.length; f < h; f++) {
                    var k = g[f];
                    k = b.replace(/\$\{link\}/g, "#" + this.id + "/" + k.id.substr(1)).replace(/\$\{section\}/g, k.title).replace(/\$\{page\}/g, k.page);
        ...
        _zoomUpdateOnRAF: function() {
            if (this._zoomDataRAF) {
                ...
                a.transform = !0;
                this._zoom(c, a);
                b && 1 > Math.abs(d) && 1 > Math.abs(g) && 1 > Math.abs(this.zoomLevel -
                    c) && (this._zoomDataRAF.callback && this._zoomDataRAF.callback.call(this), this._zoomDataRAF = null)
            }
        },
        _zoom: function(a, b) {
            b || (b = {});
            ...
            var g = a * this.currentScale;
            d = e.browser.ie7 ? 1 : c ? this._cssZoom : g;
            var f = this.zoomWindow,
                h = this.zoomContent,
            ...
            l = k.left - n.left;
            n = k.top - n.top;
            l && (l += parseFloat(f.css("marginLeft")), f.css("marginLeft", l), h.marginLeft = l);
            n && (n += parseFloat(f.css("marginTop")), f.css("marginTop", n), h.marginTop = n);
            f = "";
            n = this._zoomOffset.dx / d;
            l = this._zoomOffset.dy / d;
            e.wowBook.support.transform && (n || l) ? f = e.wowBook.utils.translate(n, l) : h.css({
                left: n,
                top: l
            });
            c ? (g /= d, f += this.opts.useScale3d ? "scale3d(" + g + "," + g + ",1)" : "scale(" + g + ")") : (this._cssZoom = g, h.css("zoom",
                g), h.css("marginLeft", -h.marginLeft / d), h.css("marginTop", -h.marginTop / d));
        ...
        zoom: function(a, b, c) {
            ...
            if (a !== this.zoomLevel || c.force)
                if (void 0 == b && (b = this.opts.zoomDuration), 0 == b) {
                    if (this._zoom(a, c), c.callback &&
                        c.callback.apply(this), this.pdf && this.pdfUpdateRender(), this.onZoom) this.onZoom(this)
                } else {
        ...
        zoomTouchSupport: function() {
            if (this.opts.touchEnabled) {
                ...
                g.on("panstart panmove", function(b) {
                    a.zoomed && (b.preventDefault(), d = null, c ||
                        (c = {
        ...
        positionBookShadow: function() {
            ...
            if (b) {
                ...
                if (a && c) this.bookShadow.hide();
                    ...
                    var e = this.elem.is(":visible") ? this.pagesContainer.position().left : parseFloat(this.pagesContainer.css("left")) ||
                        0;
        ...
        touchSupport: function() {
            ...
            e(document).on("touchend.wowbook touchcancel.wowbook", function(b) {
                if (a._touchStarted) {
                    !a._touchEnded && e(b.target).hasClass("wowbook-handle") && (b = e(b.target).data("corner"),
                        "r" === b && a.gotoRight(), "l" === b && a.gotoLeft());
                    b = a._touchStarted;
        ...
        pageEdgeDrag: function(a) {
            ...
            a = a.pageY / this.currentScale -
                this.pageGrabbedOffset.top;
        ...
        pageEdgeDragStop: function(a) {
            ...
            this._singlePage ? this.pageGrabbed.onLeft ?
                ...
                a ? this.rtl ? this.back() : this.advance() : this.releasePage(this.pageGrabbed, !0);
            this._dragging = !1;
        ...
        _setThumbnailsContainerWidth: function() {
            ...
            this.opts.thumbnailsContainerHeight && a.height(this.opts.thumbnailsContainerHeight);
        ...
        createThumbnail: function(a, b) {
            ...
            if (c) {
                ...
                (g = g.data("thumb") || g.data("thumbnail")) ? (d.addClass("wowbook-thumbnail-custom"), d.src = g) : this.opts.thumbnailsSprite ? d.css("background", 'url("' + this.opts.thumbnailsSprite + '") no-repeat 0px -' + a * b.height + "px") : this.opts.thumbnailsImages ? d.addClass("wowbook-thumbnail-custom") :
                    (g = c.clone(), g.hasClass("wowbook-page-holded") && (this.resetPage(g), g.find(".wowbook-fold-gradient-container").remove()), g.css(b.cloneCSS), b.scaleInternalPage && !c.isCover && g.css(b.scaleInternalPage), d.prepend(g));
                var f = this;
                d.click(function() {
                    f.gotoPage(a);
                    f.hideThumbnails()
        ...
        updateThumbnails: function() {
            if (this.thumbnails) {
                for (var a = this.thumbnailConfig(), b = 0, c = this.pages.length; b <
                    c; b++) this.updateThumbnail(b, a);
                this._setThumbnailsContainerWidth();
        ...
        _setThumbnailsListPosition: function(a, b) {
            ...
            b.complete = function() {
                (f.pdfDoc || f.opts.thumbnailsImages ||
                    f._customThumbnail) && f.updateVisibleThumbnails()
            };
        ...
        updateVisibleThumbnails: function() {
            if (this.thumbnails) {
                ...
                var e, f;
                for (a = 0; a < this.thumbnails.length; a++) void 0 == e && d[a] > b && (e = a), void 0 == f && d[a] > c && (f = a);
                e || (e = 0);
        ...
        toggleThumbnails: function(a) {
            e(this.thumbnailsContainer).is(":visible") ?
                this.hideThumbnails(a) : this.showThumbnails(a)
        },
        setPDF: function(a) {
            this.pdf = a;
            this.pdfRenderQueue = [];
            ...
            if (this.pdfPageRendering) this.pdfQueueRenderPage(a, b, c, d, g);
                ...
                this.pdfDoc.getPage(a + 1).then(function(h) {
                    ...
                    if (f.opts.pdfUpdateRender && "thumb" != g) {
                        var q = f.currentScale * f.zoomLevel * f.opts.pdfPixelRatio;
                        k = l.pageWidth * q;
                        var r = h.getViewport(1);
                        k = h.getViewport(k / r.width);
                        b ? e(b).addClass("wowbook-pdf-zoom-" + q).css({
                                transform: "scale(" + 1 / q + ")",
                                "transform-origin": "0 0 0"
                            }) :
                            (b = l.find(".wowbook-pdf-zoom-" + q), n = b.length, b.length || (b = e("<canvas>").addClass("wowbook-pdf-zoom-" + q), b.css({
                                transform: "scale(" + 1 / q + ")",
                                "transform-origin": "0 0 0"
                            }), m = !0), b = b[0])
                    }
                    n || (b.height = k.height, b.width = k.width);
                    q = {
                    ...
                    k = function() {
                        ...
                        if ("thumb" != g) {
                            ...
                            var d = h.getViewport(1 * f.pdfCSS_UNITS * f.opts.pdfScale);
                            d = h.getViewport(f.pdfWidth /
                                d.width * f.pdfCSS_UNITS * f.opts.pdfScale);
                            if (!l.find(".wowbook-pdf-annotations").length) {
                                var k = e('<div class="wowbook-pdf-annotations">').appendTo(l.find(".wowbook-page-content"));
                                f.pdfAnnotations(h, d, k)
                            }
                            f.opts.pdfTextSelectable && !l.textLayer && "thumb" != g && f.pdfTextLayer(h, a, d)
                        }
        ...
        pdfNavigateTo: function(a) {
            ...
            ("string" == typeof a ?
                this.pdfDoc.getDestination(a) : Promise.resolve(a)).then(function(a) {
        ...
        toggleFindBar: function(a) {
            ...
            a.hasClass("wowbook-hidden") ? (a.css("opacity", 0).removeClass("wowbook-hidden"), u(a) || a.toggleClass("wowbook-up"), a.css("opacity", 1), a.find(".wowbook-find-text").focus()) : a.addClass("wowbook-hidden")
        },
        ...
        updateContainer: function() {
            ...
            a.toolbarParent == this.containerToolbar && ((b = "top" == a.toolbarPosition) && !this.containerToolbar.is(".wowbook-top") &&
                this.containerToolbar.insertBefore(this.containerBook), !b && this.containerToolbar.is(".wowbook-top") && this.containerToolbar.insertAfter(this.containerBook), this.containerToolbar.toggleClass("wowbook-top", b), b = e(this.toolbars[0]).outerHeight(!0));
        ...
        centerLightbox: function() {
            ...
            this.opts.toolbarParent == this._lightboxElem && (this.opts.responsiveToolbar && this.updateResponsiveToolbar(), a = e(this.toolbars[0]).outerHeight(!0),
        ...
        controllify: function(a) {
            ...
            e(a.lastRight ||
                a.lastright).on("click.wowbook", function() {
                b.gotoLastRight();
                return !1
            });
            ...
            c = "zoomIn zoomOut zoomReset left lastLeft right lastRight next back first last slideShow flipSound thumbnails fullscreen toc currentPage download find".split(" ");
            for (var d, g = 0, f = c.length; g < f; g++) d = c[g].toLowerCase(), this._controls[d] = e(this._controls[d]).add(a[c[g]] || a[d]);
            this.setStrings()
        },
        ...
        createShareControl: function(a, b) {
            ...
            c = e(a).addClass("wowbook-control-share").append(f);
            var l = this;
        ...
        toggleShareButtons: function(a) {
            ...
            a.hasClass("wowbook-hidden") ? (a.css("opacity", 0).removeClass("wowbook-hidden"), u(a) || a.toggleClass("wowbook-up"), a.css("opacity", 1)) : a.addClass("wowbook-hidden")
        },
    ...
    var m = e.browser.msie && 9 > e.browser.version ? 1 : 0,
        ...
        B.msRequestFullscreen || B.webkitRequestFullscreen || B.webkitRequestFullScreen,
        D = n.exitFullscreen || n.mozCancelFullScreen || n.msExitFullscreen || n.webkitExitFullscreen || n.webkitCancelFullScreen,
        F = function() {
            return n.fullscreenElement || n.mozFullScreenElement || n.msFullscreenElement || n.webkitFullscreenElement || n.webkitCurrentFullScreenElement
        };
    e.wowBook.utils = {
        ...
        isMobile: function() {
            return 480 >=
                e(window).width() || 480 >= e(window).height()
        },
...
(function(e) {
    function p(r) {
        ...
        var w = n;
        void 0 !== m.axis && m.axis === m.HORIZONTAL_AXIS && (w = 0, u = -1 * n);
    ...
    if (e.event.fixHooks)
        for (var u = w.length; u;) e.event.fixHooks[w[--u]] =
            e.event.mouseHooks;
...
(function(e) {
    function p(p) {
        ...
        for (var m = u.length, r, n = p.charAt(0).toUpperCase() + p.substr(1); m--;)
    ...
    if (e.cssHooks) {
        ...
        e.wowBook.applyAlphaImageLoader = function(p) {
            ...
            for (r = p.length; w < r; w++) {
                var D = p[w];
                u.addClass(D);
                if (m = u.css("background-image").match(/^url\("(.*)"\)$/)) n += "." + D + "{background:none; filter : progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + m[1] + "', sizingMethod='scale'); } ",
                    u.removeClass(D)
            }
