...
$(document).ready(function() {
	...
	var ow12 = $('#customers-testimonials');
	
     owl.owlCarousel({
		nav: true,
		 navText: ["<div class='customNavigation'> <a class='btn prev'><i class='icon ion-ios-arrow-left'></i></div>","</a><div class='customNavigation'><a class='btn next'><i class='icon ion-ios-arrow-right'></i></a></div>"],
       items: 2,
       itemsDesktop: [1000, 2],
